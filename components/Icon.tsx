...
export const TourIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75v16.5M12 3.75c-3.12 0-5.625 2.61-5.625 5.813 0 3.203 2.505 5.812 5.625 5.812s5.625-2.61 5.625-5.812C17.625 6.36 15.12 3.75 12 3.75z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c3.12 0 5.625-2.61 5.625-5.813 0-3.203-2.505-5.812-5.625-5.812s-5.625 2.61-5.625 5.812c0 3.203 2.505 5.813 5.625 5.813z" />
  </svg>
);
...
export const ThunderboltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
